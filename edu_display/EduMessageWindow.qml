...
Rectangle {
    ...
    property variant texts: [
        ...
        ["基本操作をまとめるよ", -1],
        ["「まえにすすむ」って言えば前に動くよ", -1],
        ["「うしろにすすむ」って言えば後ろに動くよ", -1],
        ["「みぎにまわる」って言えば右に回転するよ", -1],
        ["「ひだりにまわる」って言えば左に回転するよ", -1],
        ["次にこれらの命令を組み合わせてみよう", -1],
        ["僕に「まえにすすむ」って言って", -1],
        ["横に“まえにすすむ“というブロックが出てくるよ", -1],
        ["次に僕に「みぎにまわる」って言って", -1],
        ["横の“まえにすすむ“というブロックの下に“みぎにまわる“というブロックが出てくるよ", -1],
        ["このようにブロックはつなげることができるよ", -1],
        ["そしてつなげたときには「とまって」というとその場で止めることができるよ", -1],
        ["僕に「とまって」「まえにすすむ」って言って", -1],
        ["「じっこう」というと前に進んだ後右に回ってちょっと止まって前に進むよ", -1],
        ["それじゃあチュートリアルの最後に今までの動きをくみあわせて僕を画像のように動かしてみよう", -1]
    ]
